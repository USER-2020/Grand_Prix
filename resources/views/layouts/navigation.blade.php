            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role(['superAdmin', 'admin'])
                        ...
                        <x-nav-link :href="route('admin.matches')" :active="request()->routeIs('admin.matches')">
                            {{ __('Manage Matches') }}
                        </x-nav-link>
                    @endrole
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @role(['superAdmin', 'admin'])
                ...
                <x-responsive-nav-link :href="route('admin.matches')" :active="request()->routeIs('admin.matches')">
                    {{ __('Manage matches') }}
                </x-responsive-nav-link>
            @endrole
